...
- **[Capable of adding new items to your todo list]**
- **[Capable of removing items from your todo list]**
...
**``git clone https://github.com/Thinus01/React_ToDo``** <p>
...
**``git clone https://github.com/Thinus01/React_ToDo``**
